...
class ActivityProvider with ChangeNotifier {
  ...
  Future<bool> uploadImage(uid) async{
    ...
    await ImageUploader()
        .uploadImage(
            image: _image, path: CloudPath.activities, id: uid)
        .then((String value) {
      _imageUrl = value;
      isUploaded=true;
    });
    ...
    if (_activityID == null) {
      ...
      if(uploadStatus){
        ...
        var newActivity = Activity(
            title: title, description: description, image: image, activityID: id);
      ...
      if(uploadStatus){
        var updatedActivity = Activity(
            title: title, description: description, image: image, activityID: _activityID);
